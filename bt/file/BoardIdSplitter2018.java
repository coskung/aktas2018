...
public class BoardIdSplitter2018 {
    ...
    static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.ENGLISH);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String emirFile = "BAP_GUNICIEMIR.M.201807.csv";
        String islemFile = "BAP_GUNICIISLEM.M.201807.csv";
...
//        }
	...
	private static Trade2018 convertLineToTrade2018(String line) {
    ...
    private static boolean thisTradeExistsThenUpdate(String line) {
        ...
        bt.utils.Parse parser = new bt.utils.Parse(line, ",");        
        String trade_number = parser.nextToken();
        //System.out.println("tradeListSize:"+tradeListFullMonth.size());
        
        for(int i=0;i<tradeListFullMonth.size();i++){
            if(tradeListFullMonth.get(i).getTrade_number().compareTo(trade_number)==0){  //this trade already exists - update buy or sell
...
//                    tradeListFullMonth.get(i).setB_emirNo(emirNo);
    ...
    public static void splitEmirlist(int fileNumber, ArrayList<Order2018> singleList) throws Exception {
        ...
        for (int i = 0; i < singleList.size(); i++) {
            ...
            if (i<singleList.size()-1 && order.getDate().compareTo(singleList.get(i+1).getDate())==0) {
        ...
        //System.out.println("order list one day size: "+orderListOneDay.size());
        //System.out.println(singleList.get(0).getMenkulKiymet() + "   " + singleList.get(0).getEmirTarihi());
